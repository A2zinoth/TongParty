...
- (void)memberSign:(NSString *)qr_code {
    [DDResponseBaseHttp getWithAction:kTJTableMemberSign params:@{@"token":curUser.token,@"tid":self.tid,@"qr_code":qr_code, @"oid":self.oid,@"latitude":curUser.latitude, @"longitude":curUser.longitude} type:kDDHttpResponseTypeJson block:^(DDResponseModel *result) {
