...
- (id)unarchiver {
    id obj = [DDFileCacheManager getObjectByFileName:[self.class description]];
    return obj;
}

- (void)archive {
    [DDFileCacheManager saveObject:self byFileName:[self.class description]];
}

- (void)remove {
    [DDFileCacheManager removeObjectByFileName:[self.class description]];
}
@end
