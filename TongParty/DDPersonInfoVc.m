...
- (void)setUpViews {
    ...
    self.navRightItem = [self customTitleButtonForNavigationWithAction:@selector(confirmToEdit:) title:@"修改" CGSize:CGSizeMake(DDFitWidth(50.f), DDFitHeight(40.f)) titleColor:kBgGrayColor];
}
#pragma mark
