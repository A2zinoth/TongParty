...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        //内边距
        self.tableView.contentInset = UIEdgeInsetsMake(kTopViewHeight(SCREEN_MAX_LENGTH)*1.3f, 0, 0, 0);
...
- (UIImageView *)heagderImageV{
    if (!_heagderImageV) {
        self.heagderImageV = [[UIImageView alloc] initWithFrame:CGRectMake(0, -kTopViewHeight(SCREEN_MAX_LENGTH), kScreenWidth, kTopViewHeight(SCREEN_MAX_LENGTH)*1.3f)];
...
- (void)setModel:(LSHisUserInfoModel *)model {
    ...
    NSRange strRange = [string rangeOfString:[NSString stringWithFormat:@"%@/%@",_model.cft_num,_model.ct_num]];
    NSRange strRange1 = [string rangeOfString:[NSString stringWithFormat:@"%@/%@",_model.jft_num,_model.jt_num]];
    [str addAttributes:@{
                         NSFontAttributeName:kFont(17.f)
                         } range:strRange];
    [str addAttributes:@{
                         NSFontAttributeName:kFont(17.f)
                         } range:strRange1];
...
-(void)customNavi{
    ...
    UIBarButtonItem *leftBtn = [self whiteBackButtonForNavigationBarWithAction:@selector(pop)];
    self.navigationItem.leftBarButtonItem = leftBtn;
    UIBarButtonItem *rightBtn = [self customTitleButtonForNavigationWithAction:@selector(moreAction:) title:@"更多" CGSize:CGSizeMake(35,20) titleColor:kWhiteColor];
...
-(void)setupViews{
    ...
    _labelView.bgColor = [UIColor hx_colorWithHexString:@"#333333" alpha:0.2f];
    ...
    _labelView1.bgColor = [UIColor hx_colorWithHexString:@"#333333" alpha:0.2f];
    ...
    _labelView2.bgColor = [UIColor hx_colorWithHexString:@"#333333" alpha:0.2f];
    ...
    _labelView3.bgColor = [UIColor hx_colorWithHexString:@"#333333" alpha:0.2f];
    ...
    [_infoView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(_joinRateLbl.mas_bottom).offset(DDFitHeight(20.f));
        make.centerX.mas_equalTo(_creditLbl.centerX);
    }];
...
-(void)moreAction:(UIBarButtonItem *)sender{
    ...
    [FDDMenu setSelectedColor:kBgBlueColor];
    if ([FDDMenu isShow]){
        [FDDMenu dismissMenu];
    } else {
