...
- (UIBarButtonItem *)customTitleButtonForNavigationWithAction:(SEL)action title:(NSString *)title CGSize:(CGSize)size titleColor:(UIColor *)color{
    UIButton* button= [UIButton buttonWithType:UIButtonTypeCustom];
    [button setTitle:title forState:UIControlStateNormal];
    [button setTitleColor:color/*kGrayColor*/ forState:UIControlStateNormal];
    [button setTitleColor:kBgBlueColor forState:UIControlStateHighlighted];
