...
-(void)setupViews{
    ...
    self.image = [UIImage imageNamed:@"person_bg_newimage"];
    ...
    [_joinRateLbl mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.mas_equalTo(self.mas_bottom).offset(DDFitHeight(-60.f));
    ...
    [_creditLbl mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(_joinRateLbl.mas_top).offset(DDFitHeight(-20.f));
    ...
    [_nameLbl mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.mas_equalTo(_creditLbl.mas_top).offset(-DDFitHeight(20.f));
    }];
    ...
    [_avatar mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.mas_equalTo(self);
        make.bottom.mas_equalTo(_nameLbl.mas_top).offset(-DDFitHeight(5.f));
    }];
    ...
    [loginBtn setTitleColor:kBgBlueColor forState:UIControlStateHighlighted];
    ...
    [registerBtn setTitleColor:kBgBlueColor forState:UIControlStateHighlighted];
    ...
    [_avatarUn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.and.height.mas_equalTo(kAvatarWidth);
        make.centerX.mas_equalTo(self);
        make.bottom.equalTo(registerBtn.mas_top).offset(-DDFitHeight(15.f));
    }];
