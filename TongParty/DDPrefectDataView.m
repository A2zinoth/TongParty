...
- (void)setupViews{
    ...
    [_maleBtn setBackgroundColor:kBgBlueColor];
    _maleBtn.layerCornerRadius = 8;
    _maleBtn.layer.borderColor = kBgBlueColor.CGColor;
    ...
    _femaleBtn.layer.borderColor = kBgBlueColor.CGColor;
    ...
    [_secretBtn setBackgroundColor:kBgBlueColor];
    self.sex = @"0";
    ...
    [_completeBtn setBackgroundColor:kBgBlueColor];
...
- (void)selectSex:(UIButton *)sender {
    for (UIButton *btn in self.btnarray) {
        btn.layer.borderColor = kBgBlueColor.CGColor;
    ...
    [sender setBackgroundColor:kBgBlueColor];
