...
- (void)setupNavi {
    ...
    if ([_titleStr isEqualToString:@"编辑地址"]) {
        self.navigationItem.rightBarButtonItem = [self customTitleButtonForNavigationWithAction:@selector(deleteAddress:) title:@"删除" CGSize:CGSizeMake(35,20) titleColor:kBgGrayColor];
    }
}
