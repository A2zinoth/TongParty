...
- (UIView *)view_title {
    if (!_view_title) {
        ...
        [_btn_map setTitleColor:kBgBlueColor forState:UIControlStateNormal];
        _btn_map.tag = 3607;
        ...
        _lbl_line.backgroundColor = kBgBlueColor;
...
-(void)modelTransform:(UIButton *)sender {
    ...
    [sender setTitleColor:kBgBlueColor forState:UIControlStateNormal];
    if (sender.tag == 3608) {
