...
- (DDCustomCommonEmptyView *)emptyView {
    if (!_emptyView) {
        DDCustomCommonEmptyView *empty = [[DDCustomCommonEmptyView alloc] initWithTitle:@"暂无数据" secondTitle:@"您还没有添加地址哦！" iconname:@"noData"];
...
- (UIButton *)btn_addNewAddress {
    ...
    if (!_btn_addNewAddress) {
        ...
        _btn_addNewAddress.backgroundColor = kBgBlueColor;
