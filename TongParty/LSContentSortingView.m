...
- (void)setupViews {;
    ...
    _btn_confirm.backgroundColor = kBgBlueColor;
...
- (void)cancel:(UIButton *)sender {
    ...
    _btn_cancel.backgroundColor = kBgBlueColor;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section <= 1) {
        ...
        cell.lbl_action.backgroundColor = entity.is_selected ? kBgBlueColor:kWhiteColor;
        ...
        if (indexPath.section - 2 >= 0) {
            ...
            cell.lbl_action.backgroundColor = childentity.is_selected ? kBgBlueColor:kWhiteColor;
...
-(void)updateCollectionViewCellStatus:(LSContentLabelCollectionViewCell *)myCollectionCell selected:(BOOL)selected {
    ...
    myCollectionCell.lbl_action.backgroundColor = selected ? kBgBlueColor:kWhiteColor;
}
